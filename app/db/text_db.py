...
class TextDB:
    ...
    @classmethod
    async def read_text_db(cls) -> list[list[str]]:
        """
        텍스트 파일 데이터베이스를 읽습니다.
        ...
        """
        if not os.path.exists(cls.DB_FILE_PATH):
            return []

        try:
            with open(cls.DB_FILE_PATH, encoding="utf-8") as f:
    ...
    @classmethod
    async def write_text_db(cls, name: str, safe_name: str) -> None:
        """
        ...
        """
        db_data = await cls.read_text_db()
        ...
        with open(cls.DB_FILE_PATH, "w", encoding="utf-8") as f:
            f.write(new_content)

    @classmethod
    async def delete_text_db(cls, name: str) -> bool:
        """
    ...
    @classmethod
    async def find_safe_name_by_name(cls, name: str) -> str | None:
        """
    ...
    @classmethod
    async def find_name_by_safe_name(cls, safe_name: str) -> str | None:
        """
